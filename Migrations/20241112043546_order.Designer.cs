...
namespace EcommercePetsFoodBackend.Migrations
{
    ...
    [Migration("20241112043546_order")]
    partial class order
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommercePetsFoodBackend.Data.Models.Customer.Customers", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsBlocked = false,
                            Name = "Admin User",
                            Password = "$2a$11$m3DQkKCnixTWQsd1m5tPG.pTreZ9mrA4cgcmLUwGIlC0f7L5Px3Qe",
                            Phone = 0L,
                            Role = "admin"
                        });
                });

            modelBuilder.Entity("EcommercePetsFoodBackend.Data.Models.Orders.Order", b =>
                {
            ...
            modelBuilder.Entity("EcommercePetsFoodBackend.Data.Models.Orders.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("EcommercePetsFoodBackend.Data.Models.Orders.OrderItem", b =>
                {
                    b.HasOne("EcommercePetsFoodBackend.Data.Models.Orders.Order", "orders")
                        .WithMany("orderItems")
